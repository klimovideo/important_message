...
Продвинутый Telegram бот для анализа и публикации важных сообщений с использованием ИИ. Система включает полнофункциональную панель администратора, модерацию постов и автоматическую публикацию в канале.
...
**Максимально удобная версия с кнопочным интерфейсом**
- ✅ Минимум команд (4 вместо 25+)
- ✅ Интуитивные Reply и Inline кнопки  
...
**Классическая версия с командами**
- 🔧 25+ команд для всех функций
...
📖 **Подробное сравнение версий:** [README_simplified.md](README_simplified.md)
...
- `/admin_channel <ID/@username>` - Настройка канала публикации
...
- `/submit_post` (ответ на пересланное сообщение) - Предложить пересланное сообщение
